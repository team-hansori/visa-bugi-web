...
const localeAnswers: Answer[] = routing.locales.map((code) => ({
  id: code,
  label: localeNames[code],
}));

const questions: Question[] = [
  { id: "locale", title: "어떤 언어가 편한가요?", description: "화면에 표시할 언어를 선택해 주세요.", answers: localeAnswers },
  ...
  { id: "visa", title: "확인하려는 체류자격이 있나요?", description: "현재는 화면 시연용 선택지이며 공식 판정에는 사용하지 않습니다.", answers: [...SUPPORTED_VISAS, { id: "OTHER", label: "다른 체류자격" }, { id: "UNKNOWN", label: "잘 모르겠어요" }] },
];
